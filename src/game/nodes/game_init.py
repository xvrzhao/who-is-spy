...
from src.game.prompts import get_words_prompt
from src.game.events import emit, GameInitStart, GameInitEnd
...
async def game_init_node(state: State) -> State:
    ...
    words: Words = await ainvoke_structured(words_llm, get_words_prompt())
