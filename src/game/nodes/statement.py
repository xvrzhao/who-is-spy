...
from src.game.state import State, StateRecord, RawRecord
from src.game.prompts import get_rules_prompt, get_statement_prompt
from src.game.llm import llm, ainvoke_structured
from src.game.tts import speak
from src.game.events import emit, StatementStart, StatementPlayerStart, StatementPlayerEnd, StatementEnd
...
async def statement_player_node(state: State) -> State:
    ...
    if current_player == state["real_player_id"]:
        ...
        stmt: Statement = await ainvoke_structured(state_llm, [
